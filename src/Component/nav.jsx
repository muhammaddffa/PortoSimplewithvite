  ...
  return (
    <>
      <div className="flex items-center justify-between p-10 lg:flex-row ">
        <div >
            <a href="#" className="text-white font-mono text-3xl tracking-wider flex items-center"><CgNametag/>DAFFA</a>
        </div>
        <div className="space-x-4">
            <div className='ssm:hidden lg:block space-x-2'> 
                ...
                <a href="#" className="text-white hover:bg-indigo-800 rounded-full px-5 py-2 text-xl">Testimoni</a>
            </div>
      ...
      <div className='ssm:block lg:hidden'>
        {toggle ? (
            ...
            <ul>
                 ...
                 <li className='text-white  text-xl mb-2 cursor-pointer'>Testimoni</li>
             </ul> 
         </div>    
        ):(
            <div></div>
